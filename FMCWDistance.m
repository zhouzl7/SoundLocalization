function measured_distance = FMCWDistance(data_signal, begin_frequency, end_frequency, fs, r0)
    ...
    start_index = 0;
    measured_distance = ((indexes-start_index) * fs / fftlen * wave_speed * clip_time / (end_frequency - begin_frequency)) * 100 + r0;
    figure(2);
